...
class BlogPost(db.Model):
    ...
    # Parent relationship to Comment: One BlogPost can have many Comments
...
class User(UserMixin, db.Model):
    ...
    # Parent relationship to Comment: One User can have many Comments
    comments: Mapped[list["Comment"]] = relationship("Comment", back_populates="comment_author")


# Create a Comment table for all comments on blog posts
class Comment(db.Model):
    __tablename__ = "comments"
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    text: Mapped[str] = mapped_column(Text, nullable=False)
    
    # Child relationship to User: Many Comments belong to One User
    author_id: Mapped[int] = mapped_column(Integer, ForeignKey("users.id"))
    comment_author: Mapped["User"] = relationship("User", back_populates="comments")
    
    # Child relationship to BlogPost: Many Comments belong to One BlogPost
